...
form.onsubmit = function (e) {
    let student = form.querySelector('input#student'),
        student_id = form.querySelector('input#student-id'),
        mark = form.querySelector('input#mark'),
        subject = form.querySelector('select#subject');

    if(student.value === ''){
        e.preventDefault();
        student.focus();
        student.classList.add('input-alert');
        form.querySelector('small.student').textContent = 'Please Write Student Name Or Id';
    }else{
        student.classList.remove('input-alert');
        form.querySelector('small.student').textContent = '';
